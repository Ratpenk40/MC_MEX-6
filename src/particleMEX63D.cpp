...
particleMEX63D::particleMEX63D(std::mt19937* generator ):x(0)
...
void particleMEX63D::SetSettings(float initial_slow_, float initial_fast_, float k_fast_slow_, float k_slow_fast_low_, float k_slow_fast_high_){
...
particleMEX63D::~particleMEX63D()
{
    
}

void particleMEX63D::Shuffle(double limits[][3]){
...
bool particleMEX63D::InsideEllipse(double x_ ,double y_, double z_, double limits[][3]){
...
void particleMEX63D::ChangeID(double limits[][3], double t){
...
double particleMEX63D::funclin(double x_, double t){
...
void particleMEX63D::Move(double v0, double v1, double dt, double limits[][3], bool nobound, double t){
